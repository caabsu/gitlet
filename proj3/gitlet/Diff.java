...
public class Diff {
    ...
    public static void setSequences(File file1, File file2) {
        try {
    ...
    private static List<String> _lines1;

    /** Second sequences. */
    private static List<String> _lines2;
    ...
    private static int[][] _lls;

    /** A stack structure used by lls. */
    private static int[] _todo;
